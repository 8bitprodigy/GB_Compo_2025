...
S:Lmain.set_bkg_native_data$data$1_0$117({2}DG,SC:U),B,1,2
S:Lmain.set_bkg_native_data$nb_tiles$1_0$117({1}SC:U),B,1,-1
S:Lmain.set_bkg_native_data$first_tile$1_0$117({1}SC:U),B,1,-2
S:Lmain.set_sprite_native_data$data$1_0$119({2}DG,SC:U),B,1,2
S:Lmain.set_sprite_native_data$nb_tiles$1_0$119({1}SC:U),B,1,-1
S:Lmain.set_sprite_native_data$first_tile$1_0$119({1}SC:U),B,1,-2
S:Lmain.aligned_alloc$size$1_0$149({2}SI:U),B,1,-2
S:Lmain.aligned_alloc$alignment$1_0$149({2}SI:U),B,1,-4
F:G$main$0_0$0({2}DF,SV:S),C,0,0,0,0,0
T:Fmain$__00000000[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Fmain$__00000010[({0}S:S$w$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
...
T:Fmain$__00000005[({0}S:S$v$0_0$0({2}DA2d,SC:S),Z,0,0)({0}S:S$x$0_0$0({1}SC:S),Z,0,0)({1}S:S$y$0_0$0({1}SC:S),Z,0,0)({0}S:S$w$0_0$0({1}SC:S),Z,0,0)({1}S:S$h$0_0$0({1}SC:S),Z,0,0)]
T:Fmain$__00000006[({0}S:S$x$0_0$0({1}SC:S),Z,0,0)({1}S:S$y$0_0$0({1}SC:S),Z,0,0)]
T:Fmain$__00000007[({0}S:S$w$0_0$0({1}SC:S),Z,0,0)({1}S:S$h$0_0$0({1}SC:S),Z,0,0)]
T:Fmain$__00000008[({0}S:S$v$0_0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$x$0_0$0({1}SC:U),Z,0,0)({1}S:S$y$0_0$0({1}SC:U),Z,0,0)({0}S:S$w$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Fmain$__00000009[({0}S:S$x$0_0$0({1}SC:U),Z,0,0)({1}S:S$y$0_0$0({1}SC:U),Z,0,0)]
